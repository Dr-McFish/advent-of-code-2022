...
void print_matrix(bool visited_matrix[M_SIZE][M_SIZE], cords_list_t rope);
...
int main() {
	...
	// ########################### PROSSES DATA ###########################
	rope = maillon_creer(cords_zero(), maillon_creer(cords_zero(), maillon_creer(cords_zero(), maillon_creer(cords_zero(), maillon_creer(cords_zero(), maillon_creer(cords_zero(), maillon_creer(cords_zero(), maillon_creer(cords_zero(), maillon_creer(cords_zero(), maillon_creer(cords_zero(), NULL))))))))));
	...
	for (int i = 0; i < line_count; i++) {
		...
		assert(abs(rope->head.y) < (M_SIZE/2) );
		assert(abs(rope->head.x) < (M_SIZE/2) );
