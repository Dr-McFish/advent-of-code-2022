...
bool addition_overflow(int64_t a, int64_t b);
bool substraction_overflow(int64_t a, int64_t b);
bool multiplication_overflow(int64_t a, int64_t b);
...
int main() {
	...
	int64_t desired_result = monkeys[monkeys[root].operands[0]].knowns_his_num 
