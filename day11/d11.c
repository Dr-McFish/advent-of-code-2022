...
void monkey_do_turn(monkey_t* monkeys[], int monkey_idx);
...
#define NUM_ROUNDS 20
	...
	printf("Monkey buissnes: %d\n %d, %d\n", most_items_inspected * scnd_most_items_inspected, most_items_inspected, scnd_most_items_inspected);
